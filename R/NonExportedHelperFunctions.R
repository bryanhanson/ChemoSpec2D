...
#' 
#' @param spectra An \emph{incomplete} object of S3 class \code{\link{Spectra2D}}
#'                which is missing \code{spectra$groups} and \code{spectra$colors}.
#' 
...
.groupNcolor2D <- function(spectra, gr.crit = NULL, gr.cols = "auto") {
    ...
    msg2 <- "More groups than colors.\nRedefine groups, specify colors manually, or fix up the\nSpectra2D object (use sumSpectra2D to see what happened)."
